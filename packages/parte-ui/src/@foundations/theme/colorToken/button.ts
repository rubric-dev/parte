const buttonColorToken = {
  colorBackgroundButtonPrimary: "PRIMARY400",
  colorBackgroundButtonPrimaryHover: "PRIMARY500",
  colorBackgroundButtonPrimaryActive: "PRIMARY600",
  colorBackgroundButtonPrimaryFocused: "PRIMARY500",
  colorBackgroundButtonPrimaryDisabled: "PRIMARY200",
